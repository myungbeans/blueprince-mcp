...
// ListHandler creates a handler for listing notes, with access to the application config.
func ListHandler(ctx context.Context, cfg *config.Config) server.ToolHandlerFunc {
